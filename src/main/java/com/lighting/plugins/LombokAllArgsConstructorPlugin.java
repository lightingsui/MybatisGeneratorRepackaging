 ...
 *
 * @author ：Lightingsui
 * @since ：2020/2/28 17:16
 */
public class LombokAllArgsConstructorPlugin extends PluginAdapter {
    /**
    ...
    public boolean modelBaseRecordClassGenerated(TopLevelClass topLevelClass,
        ...
        addAllArgsConstructorAnnotation(topLevelClass, introspectedTable);
    ...
    private boolean addAllArgsConstructorAnnotation(TopLevelClass topLevelClass,
                                      IntrospectedTable introspectedTable){
